...
background = pygame.image.load('img/bh.jpg').convert()
background_rect = background.get_rect()
player_img = pygame.image.load(path.join(img_dir, "playercat.png")).convert()
attacker_img = pygame.image.load(path.join(img_dir, "attackerlemon.png")).convert()
...
while running:
    ...
    hits = pygame.sprite.spritecollide(player, attackers, False) #whether attack or thing i hit should be deleted or not
    if hits:
        running = False
